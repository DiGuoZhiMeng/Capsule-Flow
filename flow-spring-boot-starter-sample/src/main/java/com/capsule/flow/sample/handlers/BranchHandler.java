...
@Component
@Slf4j
public class BranchHandler extends AbstractFlowHandler<Branch> {
     ...
     *
     * @param branch 处理后的单据对象
     */
    @Override
    public void afterProcess(Branch branch) {
        branchService.updateById(branch.setUpdateTime(LocalDateTime.now()));
    }
