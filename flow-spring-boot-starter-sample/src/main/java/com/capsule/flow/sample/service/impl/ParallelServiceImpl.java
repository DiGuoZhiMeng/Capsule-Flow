...
import com.capsule.flow.sample.mapper.ParallelMapper;
...
@Slf4j
@Service
public class ParallelServiceImpl extends ServiceImpl<ParallelMapper, Parallel> implements ParallelService {
